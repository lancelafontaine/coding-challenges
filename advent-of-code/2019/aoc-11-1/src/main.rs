...
impl HullPanel {
    ...
    fn number_of_squares_painted(&self) -> usize {
        self.grid.len()
    }
}
...
impl PaintingRobot {
    ...
    fn number_of_squares_painted(&self) -> usize {
        self.hull_panel.number_of_squares_painted()
    }
}
...
fn main() -> Result<()> {
    ...
    let mut input = robot.read() as i64;
    loop {
    ...
    writeln!(stdout_handle, "{}", robot.number_of_squares_painted())?;
    Ok(())
}
